...
INSERT INTO `beneficio` VALUES (1,'2012-08-28 06:00:00',1,1,1),(2,'2012-08-01 06:00:00',1,1,1),(3,'2012-08-26 06:00:00',1,1,1);
...
INSERT INTO `beneficioDetalle` VALUES (1,200,200,NULL,1,1,1,1),(2,500,500,NULL,1,1,1,1),(3,200,200,NULL,1,1,1,1),(4,12,12,NULL,1,1,3,1);
...
INSERT INTO `calibre` VALUES (1,'10','nose',1,1,1);
...
INSERT INTO `cliente` VALUES (1,'francisco','mendoza','1987-03-19 07:00:00','','','','','','','','',1,1,1);
...
INSERT INTO `entrada` VALUES (1,1,'2012-09-01 06:00:00','nose','','','','','',1000,100,900,0,900,-84,1,1,1,1,1,2,1,1,1);
...
CREATE TABLE `salidaDirecta` (
  ...
  KEY `salidaDirecta_unidad` (`unidad_did`),
  ...
  CONSTRAINT `salidaDirecta_unidad` FOREIGN KEY (`unidad_did`) REFERENCES `unidad` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `salidaDirecta` VALUES (1,'12','2012-08-29 06:00:00',1,12,1,1,1),(2,'123','2001-05-17 06:00:00',1,12,1,1,1);
...
INSERT INTO `usuario` VALUES (1,'francisco','123qwe',1,1),(2,'anarosa','123',1,1);
...
-- Dump completed on 2012-10-04 18:49:14
