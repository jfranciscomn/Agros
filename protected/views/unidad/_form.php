...
<?php $form=$this->beginWidget('BActiveForm', array(
	...
	<div class="<?php echo $form->fieldClass($model, 'equivalencia'); ?>">
		<?php echo $form->labelEx($model,'equivalencia'); ?>
		<div class="input">
			
			<?php echo $form->textField($model,'equivalencia'); ?>
			<?php echo $form->error($model,'equivalencia'); ?>
		</div>
	</div>
