<table class="table table-bordered table-striped">
	<tr>
		...
		<?php /*
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('placas')); ?></b>
		</td>
		<td >
		...
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('taraCamion')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('pesoNeto')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('impuresas')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('pesoNetoAnalizado')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('saldo')); ?></b>
		</td>
		...
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('estado_did')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('municipio_aid')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('ejido_did')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('estatus_did')); ?></b>
		</td>
		<td >
			<b><?php echo CHtml::encode($data->getAttributeLabel('temporada_did')); ?></b>
		</td>
		*/ ?>
	</tr>
