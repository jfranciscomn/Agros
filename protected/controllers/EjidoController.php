...
class EjidoController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Ejido']))
		{
			$model->attributes=$_POST['Ejido'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Ejido');
	...
	{
		$model=new Ejido('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Ejido']))
			$model->attributes=$_GET['Ejido'];
	...
	{
		$model=Ejido::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='ejido-form')
		{
	...
	public function actionAutocompletesearch()
	{
	    ...
	    if (!empty($q))
	    {
			...
			$criteria->limit='10';
	       	$cursor = Ejido::model()->findAll($criteria);
