...
class VariedadController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Variedad'];
			if($model->save())
	...
	{
		$model=Variedad::model()->findByPk((int)$id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='variedad-form')
		{
	...
	public function actionAutocompletesearch()
	{
	    ...
	    if (!empty($q))
	    {
			...
			$criteria->limit='10';
	       	$cursor = Variedad::model()->findAll($criteria);
	...
	{
		echo CHtml::tag('option',array(),CHtml::encode('Seleccione una Variedad'),true);
